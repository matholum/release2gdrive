module.exports = {
  ...
  scopes: [
    { name: 'tool', description: 'anything specific to the tool itself' },
    { name: 'build', description: 'anything specific the build tooling' },
    {
      name: 'repo',
    ...
    {
      name: 'testing',
      description: 'anything testing specific',
    },
